...
const getArgs = async (mode, modeOpts, videoFilename, [timeStart, timeEnd], outName, config) => {
...
const render = async (mode, modeOpts, videoFilename, [timeStart, timeEnd], outName, config) => {
    const args = await getArgs(mode, modeOpts, videoFilename, [timeStart, timeEnd], outName, config);
